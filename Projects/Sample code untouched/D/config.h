...
// ------- compiler PRAM option --------------
	...
	#ifdef _MFDSP_
	#pragma comment(OPTION, "pram=0x20280-0x20400")
	#endif

	#ifdef _MSPEECHDSP_
	#pragma comment(OPTION, "pram=0x70280-0x70400")
	#endif

	#ifdef _MSPEECHDSP2_
	#pragma comment(OPTION, "pram=0xF0280-0xF0400")
	#endif

	#ifdef _MFDSP2_
	#pragma comment(OPTION, "pram=0xF0300-0xF0800")
	#endif

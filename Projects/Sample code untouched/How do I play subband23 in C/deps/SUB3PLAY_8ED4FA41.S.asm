...
_A735335B1_87:;					=>>_A735335B1_87:;
	
_A735335B1_88:;					=>>_A735335B1_88:;
	asm AX = PCMY+0;			=>>AX = PCMY+0//
_A735335B1_89:;					=>>_A735335B1_89:;
	asm	AR = AX				=>>AR = AX
_A735335B1_90:;					=>>_A735335B1_90:;
	asm	I0 = AR				=>>I0 = AR
	
	
_A735335B1_91:;					=>>_A735335B1_91:;
	_i_1_2+0	= 0x0200;		=>>I1	= rm[BP_SAVE];AX	= 0x0200;rm[I1]	= AX
LFB78B58C_30:;					=>>LFB78B58C_30:;
_A735335B1_92:;					=>>_A735335B1_92:;
...
rjmp void _WaitPCM_Empty_size53398B9D()		=>>_WaitPCM_Empty_size53398B9D:
{
	__int16 _x_1_2;
						=>>AR	= rm[BP_SAVE];push	AR;AR	= BP;rm[BP_SAVE]	= AR;AR	 = -1;BP	+= AR
_A735335B1_111:;				=>>_A735335B1_111:;
	
_A735335B1_112:;				=>>_A735335B1_112:;
	asm I1 = PCMYOU_PTR+0;			=>>I1 = PCMYOU_PTR+0//
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	asm I1 = PCMYIN_PTR+0;			=>>I1 = PCMYIN_PTR+0//
	sCX	= *(__int16*)sSI;		=>>CX	= rm[I1]
...
_A735335B1_115:;				=>>_A735335B1_115:;
_A735335B1_116:;				=>>_A735335B1_116:;
	sSI	= (int)&_x_1_2;			=>>I1	= rm[BP_SAVE]
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
...
rjmp void _Sub3ZeroFillABFF23AA()		=>>_Sub3ZeroFillABFF23AA:
{
	__int16 _i_1_2;
						=>>AR	= rm[BP_SAVE];push	AR;AR	= BP;rm[BP_SAVE]	= AR;AR	 = -1;BP	+= AR
_A735335B1_120:;				=>>_A735335B1_120:;
_A735335B1_121:;				=>>_A735335B1_121:;
	asm	push CBL			=>>push CBL
	
_A735335B1_122:;				=>>_A735335B1_122:;
	io[0x3B]	= 0x0009;		=>>AR	= 0x09;io[0x3B]	= AR
	
_A735335B1_123:;				=>>_A735335B1_123:;
	asm I1 = PCMYIN_PTR+0;			=>>I1 = PCMYIN_PTR+0//
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
_A735335B1_124:;				=>>_A735335B1_124:;
	asm	AR = AX				=>>AR = AX
_A735335B1_125:;				=>>_A735335B1_125:;
	asm	I0 = AR				=>>I0 = AR
	
_A735335B1_126:;				=>>_A735335B1_126:;
	_i_1_2+0	= 0x0120;		=>>I1	= rm[BP_SAVE];AX	= 0x0120;rm[I1]	= AX
LFB78B58C_38:;					=>>LFB78B58C_38:;
_A735335B1_127:;				=>>_A735335B1_127:;
	sSI	= (int)&_i_1_2;			=>>I1	= rm[BP_SAVE]
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sSI	= (int)&_i_1_2;			=>>I1	= rm[BP_SAVE]
	asm AR = 0x0001;			=>>AR = 0x0001//
...
_A735335B1_128:;				=>>_A735335B1_128:;
	sAX	= 0x0000;			=>>AX	= 0x00
_A735335B1_129:;				=>>_A735335B1_129:;
	asm	rm[I0++] = AX			=>>rm[I0++] = AX
_A735335B1_130:;				=>>_A735335B1_130:;
	goto LFB78B58C_38;			=>>jmp	LFB78B58C_38
LFB78B58C_37:;					=>>LFB78B58C_37:;
_A735335B1_131:;				=>>_A735335B1_131:;
_A735335B1_132:;				=>>_A735335B1_132:;
	get_I0();				=>>push	I0;pop	AX;
	asm I1 = PCMYIN_PTR+0;			=>>I1 = PCMYIN_PTR+0//
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_A735335B1_133:;				=>>_A735335B1_133:;
	asm	pop CBL				=>>pop CBL
LFB78B58C_36:;					=>>LFB78B58C_36:;
_A735335B1_134:;				=>>_A735335B1_134:;
	return;					=>>AR	= 1;BP	+= AR;pop	AR;rm[BP_SAVE]	= AR;rets
_Sub3ZeroFillABFF23AA_end:;			=>>_Sub3ZeroFillABFF23AA_end:;
_A735335B1_135:;				=>>_A735335B1_135:;
}
...
_A735335B1_136:;				=>>_A735335B1_136:;
	
_A735335B1_137:;				=>>_A735335B1_137:;
...
_A735335B1_138:;				=>>_A735335B1_138:;
_A735335B1_139:;				=>>_A735335B1_139:;
	_Sub3Initial96BE24F3();			=>>pch	= _Sub3Initial96BE24F3;lcall	_Sub3Initial96BE24F3
_A735335B1_140:;				=>>_A735335B1_140:;
	asm AX = SUBFLTI+0;			=>>AX = SUBFLTI+0//
	PUSH(sAX);				=>>push	AX
	sAX	= 0x0000;			=>>AX	= 0x00
	sSI	= POP();			=>>pop	I1
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_A735335B1_141:;				=>>_A735335B1_141:;
	asm AX = SUBFLTI+1;			=>>AX = SUBFLTI+1//
	PUSH(sAX);				=>>push	AX
	sAX	= 0x0000;			=>>AX	= 0x00
	sSI	= POP();			=>>pop	I1
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_A735335B1_142:;				=>>_A735335B1_142:;
	asm AX = SUBFLTI+2;			=>>AX = SUBFLTI+2//
	PUSH(sAX);				=>>push	AX
	sAX	= 0x0000;			=>>AX	= 0x00
	sSI	= POP();			=>>pop	I1
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_A735335B1_143:;				=>>_A735335B1_143:;
	asm AX = SUBFLTI+3;			=>>AX = SUBFLTI+3//
	PUSH(sAX);				=>>push	AX
	sAX	= 0x0000;			=>>AX	= 0x00
	sSI	= POP();			=>>pop	I1
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_A735335B1_144:;				=>>_A735335B1_144:;
	sAX	= 0x0000;			=>>AX	= 0x00
	asm I1 = SUBFLTA+0;			=>>I1 = SUBFLTA+0//
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_A735335B1_145:;				=>>_A735335B1_145:;
	asm I1 = SampleCh0Rate+0;		=>>I1 = SampleCh0Rate+0//
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	asm I1 = SUBFLTP+0;			=>>I1 = SUBFLTP+0//
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_A735335B1_146:;				=>>_A735335B1_146:;
	sAX	= 0x003F;			=>>AX	= 0x3F
	asm I1 = SUBFLTG+0;			=>>I1 = SUBFLTG+0//
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_A735335B1_147:;				=>>_A735335B1_147:;
	asm	set io[INTENA].b0		=>>set io[INTENA].b0
_A735335B1_148:;				=>>_A735335B1_148:;
	asm	eni				=>>eni
LFB78B58C_40:;					=>>LFB78B58C_40:;
_A735335B1_149:;				=>>_A735335B1_149:;
	return;					=>>pop	AR;rm[BP_SAVE]	= AR;rets
_Sub3Play422CAD6D_end:;				=>>_Sub3Play422CAD6D_end:;
_A735335B1_150:;				=>>_A735335B1_150:;
}

rjmp void Sbb_Ch0GetBts()			=>>Sbb_Ch0GetBts:
{
_A735335B1_151:;				=>>_A735335B1_151:;
_A735335B1_152:;				=>>_A735335B1_152:;
	asm	push I1				=>>push I1
_A735335B1_153:;				=>>_A735335B1_153:;
	asm	push P1				=>>push P1
_A735335B1_154:;				=>>_A735335B1_154:;
	asm	push AX				=>>push AX
_A735335B1_155:;				=>>_A735335B1_155:;
	asm	push BX				=>>push BX
_A735335B1_156:;				=>>_A735335B1_156:;
	asm	push CX				=>>push CX
_A735335B1_157:;				=>>_A735335B1_157:;
	asm	push DX				=>>push DX
_A735335B1_158:;				=>>_A735335B1_158:;
	asm	AR = P1.hh			=>>AR = P1.hh
_A735335B1_159:;				=>>_A735335B1_159:;
	asm	push AR				=>>push AR
	
_A735335B1_160:;				=>>_A735335B1_160:;
_A735335B1_161:;				=>>_A735335B1_161:;
_A735335B1_162:;				=>>_A735335B1_162:;
	asm I1 = bts_ch0_get_ix+0;		=>>I1 = bts_ch0_get_ix+0//
	sAX	= *(__int16*)sSI++;		=>>AX	= rm[I1++]
	sDX	= *(__int16*)sSI--;		=>>DX	= rm[I1--]
	...
	RESTORESP(1);				=>>pop	AR;
_A735335B1_163:;				=>>_A735335B1_163:;
	asm	pop AR				=>>pop AR
_A735335B1_164:;				=>>_A735335B1_164:;
	asm	P1.hh = AR			=>>P1.hh = AR
_A735335B1_165:;				=>>_A735335B1_165:;
	asm	pop DX				=>>pop DX
_A735335B1_166:;				=>>_A735335B1_166:;
	asm	pop CX				=>>pop CX
_A735335B1_167:;				=>>_A735335B1_167:;
	asm	pop BX				=>>pop BX
	
_A735335B1_168:;				=>>_A735335B1_168:;
_A735335B1_169:;				=>>_A735335B1_169:;
	asintax();				=>>_A735335B1_170:;				=>>_A735335B1_170:;
	asm	AR = AX				=>>AR = AX
_A735335B1_171:;				=>>_A735335B1_171:;
	asm	pop AX				=>>pop AX
_A735335B1_172:;				=>>_A735335B1_172:;
	asm	pop P1				=>>pop P1
_A735335B1_173:;				=>>_A735335B1_173:;
	asm	pop I1				=>>pop I1
LFB78B58C_41:;					=>>LFB78B58C_41:;
_A735335B1_174:;				=>>_A735335B1_174:;
	return;					=>>rets
Sbb_Ch0GetBts_end:;				=>>Sbb_Ch0GetBts_end:;
_A735335B1_175:;				=>>_A735335B1_175:;
}
...
_A735335B1_176:;				=>>_A735335B1_176:;
	return;					=>>pop	AR;rm[BP_SAVE]	= AR;rets
_Sbb_SkipdataE1C72441_end:;			=>>_Sbb_SkipdataE1C72441_end:;
_A735335B1_177:;				=>>_A735335B1_177:;
}

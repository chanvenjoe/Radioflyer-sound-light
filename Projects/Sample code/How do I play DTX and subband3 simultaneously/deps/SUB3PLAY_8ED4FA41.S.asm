...
_AFFC519C6_248:;				=>>_AFFC519C6_248:;
	
_AFFC519C6_249:;				=>>_AFFC519C6_249:;
	asm AX = PCMY+0;			=>>AX = PCMY+0//
_AFFC519C6_250:;				=>>_AFFC519C6_250:;
	asm	AR = AX				=>>AR = AX
_AFFC519C6_251:;				=>>_AFFC519C6_251:;
	asm	I0 = AR				=>>I0 = AR
_AFFC519C6_252:;				=>>_AFFC519C6_252:;
	_i_1_2+0	= 0x0200;		=>>I1	= rm[BP_SAVE];AR	= 0x0200;rm[I1]	= AR
LFB78B58C_103:;					=>>LFB78B58C_103:;
_AFFC519C6_253:;				=>>_AFFC519C6_253:;
...
rjmp void _WaitPCM_Empty_size53398B9D()		=>>_WaitPCM_Empty_size53398B9D:
{
	__int16 _x_1_2;
						=>>AR	= rm[BP_SAVE];push	AR;AR	= BP;rm[BP_SAVE]	= AR;AR	 = -1;BP	+= AR
_AFFC519C6_273:;				=>>_AFFC519C6_273:;
_AFFC519C6_274:;				=>>_AFFC519C6_274:;
	asm I1 = PCMYOU_PTR+0;			=>>I1 = PCMYOU_PTR+0//
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	asm I1 = PCMYIN_PTR+0;			=>>I1 = PCMYIN_PTR+0//
	sCX	= *(__int16*)sSI;		=>>CX	= rm[I1]
...
_AFFC519C6_277:;				=>>_AFFC519C6_277:;
_AFFC519C6_278:;				=>>_AFFC519C6_278:;
	sSI	= (int)&_x_1_2;			=>>I1	= rm[BP_SAVE]
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
...
rjmp void _Sub3ZeroFillABFF23AA()		=>>_Sub3ZeroFillABFF23AA:
{
	__int16 _i_1_2;
						=>>AR	= rm[BP_SAVE];push	AR;AR	= BP;rm[BP_SAVE]	= AR;AR	 = -1;BP	+= AR
_AFFC519C6_282:;				=>>_AFFC519C6_282:;
_AFFC519C6_283:;				=>>_AFFC519C6_283:;
	asm	push CBL			=>>push CBL
_AFFC519C6_284:;				=>>_AFFC519C6_284:;
	io[0x3B]	= 0x0009;		=>>AR	= 0x09;io[0x3B]	= AR
	
_AFFC519C6_285:;				=>>_AFFC519C6_285:;
	asm I1 = PCMYIN_PTR+0;			=>>I1 = PCMYIN_PTR+0//
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
_AFFC519C6_286:;				=>>_AFFC519C6_286:;
	asm	AR = AX				=>>AR = AX
_AFFC519C6_287:;				=>>_AFFC519C6_287:;
	asm	I0 = AR				=>>I0 = AR
_AFFC519C6_288:;				=>>_AFFC519C6_288:;
	_i_1_2+0	= 0x0120;		=>>I1	= rm[BP_SAVE];AR	= 0x0120;rm[I1]	= AR
LFB78B58C_111:;					=>>LFB78B58C_111:;
_AFFC519C6_289:;				=>>_AFFC519C6_289:;
	sSI	= (int)&_i_1_2;			=>>I1	= rm[BP_SAVE]
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sSI	= (int)&_i_1_2;			=>>I1	= rm[BP_SAVE]
	asm AR = 0x0001;			=>>AR = 0x0001//
...
_AFFC519C6_290:;				=>>_AFFC519C6_290:;
	sAX	= 0x0000;			=>>AX	= 0x00
_AFFC519C6_291:;				=>>_AFFC519C6_291:;
	asm	rm[I0++] = AX			=>>rm[I0++] = AX
	goto LFB78B58C_111;			=>>jmp	LFB78B58C_111
LFB78B58C_110:;					=>>LFB78B58C_110:;
_AFFC519C6_292:;				=>>_AFFC519C6_292:;
_AFFC519C6_293:;				=>>_AFFC519C6_293:;
	get_I0();				=>>push	I0;pop	AX;
	asm I1 = PCMYIN_PTR+0;			=>>I1 = PCMYIN_PTR+0//
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AFFC519C6_294:;				=>>_AFFC519C6_294:;
	asm	pop CBL				=>>pop CBL
LFB78B58C_109:;					=>>LFB78B58C_109:;
_AFFC519C6_295:;				=>>_AFFC519C6_295:;
	return;					=>>AR	= 1;BP	+= AR;pop	AR;rm[BP_SAVE]	= AR;rets
_Sub3ZeroFillABFF23AA_end:;			=>>_Sub3ZeroFillABFF23AA_end:;
_AFFC519C6_296:;				=>>_AFFC519C6_296:;
}
...
_AFFC519C6_297:;				=>>_AFFC519C6_297:;
	
_AFFC519C6_298:;				=>>_AFFC519C6_298:;
_AFFC519C6_299:;				=>>_AFFC519C6_299:;
	dtxStopSong();				=>>pch	= dtxStopSong;lcall	dtxStopSong
_AFFC519C6_300:;				=>>_AFFC519C6_300:;
...
_AFFC519C6_301:;				=>>_AFFC519C6_301:;
_AFFC519C6_302:;				=>>_AFFC519C6_302:;
	_Sub3Initial96BE24F3();			=>>pch	= _Sub3Initial96BE24F3;lcall	_Sub3Initial96BE24F3
_AFFC519C6_303:;				=>>_AFFC519C6_303:;
	asm AX = SUBFLTI+0;			=>>AX = SUBFLTI+0//
	PUSH(sAX);				=>>push	AX
	sAX	= 0x0000;			=>>AX	= 0x00
	sSI	= POP();			=>>pop	I1
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AFFC519C6_304:;				=>>_AFFC519C6_304:;
	asm AX = SUBFLTI+1;			=>>AX = SUBFLTI+1//
	PUSH(sAX);				=>>push	AX
	sAX	= 0x0000;			=>>AX	= 0x00
	sSI	= POP();			=>>pop	I1
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AFFC519C6_305:;				=>>_AFFC519C6_305:;
	asm AX = SUBFLTI+2;			=>>AX = SUBFLTI+2//
	PUSH(sAX);				=>>push	AX
	sAX	= 0x0000;			=>>AX	= 0x00
	sSI	= POP();			=>>pop	I1
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AFFC519C6_306:;				=>>_AFFC519C6_306:;
	asm AX = SUBFLTI+3;			=>>AX = SUBFLTI+3//
	PUSH(sAX);				=>>push	AX
	sAX	= 0x0000;			=>>AX	= 0x00
	sSI	= POP();			=>>pop	I1
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AFFC519C6_307:;				=>>_AFFC519C6_307:;
	sAX	= 0x0000;			=>>AX	= 0x00
	asm I1 = SUBFLTA+0;			=>>I1 = SUBFLTA+0//
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AFFC519C6_308:;				=>>_AFFC519C6_308:;
	asm I1 = SampleCh0Rate+0;		=>>I1 = SampleCh0Rate+0//
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	asm I1 = SUBFLTP+0;			=>>I1 = SUBFLTP+0//
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AFFC519C6_309:;				=>>_AFFC519C6_309:;
	sAX	= 0x003F;			=>>AX	= 0x3F
	asm I1 = SUBFLTG+0;			=>>I1 = SUBFLTG+0//
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AFFC519C6_310:;				=>>_AFFC519C6_310:;
	asm	set io[INTENA].b0		=>>set io[INTENA].b0
_AFFC519C6_311:;				=>>_AFFC519C6_311:;
	asm	eni				=>>eni
LFB78B58C_113:;					=>>LFB78B58C_113:;
_AFFC519C6_312:;				=>>_AFFC519C6_312:;
	return;					=>>pop	AR;rm[BP_SAVE]	= AR;rets
_Sub3Play422CAD6D_end:;				=>>_Sub3Play422CAD6D_end:;
_AFFC519C6_313:;				=>>_AFFC519C6_313:;
}

naked rjmp void Sbb_Ch0GetBts()			=>>Sbb_Ch0GetBts:
{
_AFFC519C6_314:;				=>>_AFFC519C6_314:;
_AFFC519C6_315:;				=>>_AFFC519C6_315:;
	asm	push I1				=>>push I1
_AFFC519C6_316:;				=>>_AFFC519C6_316:;
	asm	push P1				=>>push P1
_AFFC519C6_317:;				=>>_AFFC519C6_317:;
	asm	push AX				=>>push AX
_AFFC519C6_318:;				=>>_AFFC519C6_318:;
	asm	push BX				=>>push BX
_AFFC519C6_319:;				=>>_AFFC519C6_319:;
	asm	push CX				=>>push CX
_AFFC519C6_320:;				=>>_AFFC519C6_320:;
	asm	push DX				=>>push DX
_AFFC519C6_321:;				=>>_AFFC519C6_321:;
	asm	AR = P1.hh			=>>AR = P1.hh
_AFFC519C6_322:;				=>>_AFFC519C6_322:;
	asm	push AR				=>>push AR
	
_AFFC519C6_323:;				=>>_AFFC519C6_323:;
_AFFC519C6_324:;				=>>_AFFC519C6_324:;
_AFFC519C6_325:;				=>>_AFFC519C6_325:;
	asm I1 = bts_ch0_get_ix+0;		=>>I1 = bts_ch0_get_ix+0//
	sAX	= *(__int16*)sSI++;		=>>AX	= rm[I1++]
	sDX	= *(__int16*)sSI--;		=>>DX	= rm[I1--]
...
_AFFC519C6_326:;				=>>_AFFC519C6_326:;
	asm	pop AR				=>>pop AR
_AFFC519C6_327:;				=>>_AFFC519C6_327:;
	asm	P1.hh = AR			=>>P1.hh = AR
_AFFC519C6_328:;				=>>_AFFC519C6_328:;
	asm	AR = AX				=>>AR = AX
	
_AFFC519C6_329:;				=>>_AFFC519C6_329:;
	asm	pop DX				=>>pop DX
_AFFC519C6_330:;				=>>_AFFC519C6_330:;
	asm	pop CX				=>>pop CX
_AFFC519C6_331:;				=>>_AFFC519C6_331:;
	asm	pop BX				=>>pop BX
_AFFC519C6_332:;				=>>_AFFC519C6_332:;
	asm	pop AX				=>>pop AX
_AFFC519C6_333:;				=>>_AFFC519C6_333:;
	asm	pop P1				=>>pop P1
_AFFC519C6_334:;				=>>_AFFC519C6_334:;
	asm	pop I1				=>>pop I1
LFB78B58C_114:;					=>>LFB78B58C_114:;
_AFFC519C6_335:;				=>>_AFFC519C6_335:;
	return;					=>>rets
Sbb_Ch0GetBts_end:;				=>>Sbb_Ch0GetBts_end:;
_AFFC519C6_336:;				=>>_AFFC519C6_336:;
}

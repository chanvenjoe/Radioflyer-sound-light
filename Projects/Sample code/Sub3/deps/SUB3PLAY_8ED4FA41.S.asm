...
_AE23BDF6A_87:;					=>>_AE23BDF6A_87:;
	
_AE23BDF6A_88:;					=>>_AE23BDF6A_88:;
	asm AX = PCMY+0;			=>>AX = PCMY+0//
_AE23BDF6A_89:;					=>>_AE23BDF6A_89:;
	asm	AR = AX				=>>AR = AX
_AE23BDF6A_90:;					=>>_AE23BDF6A_90:;
	asm	I0 = AR				=>>I0 = AR
	
	
_AE23BDF6A_91:;					=>>_AE23BDF6A_91:;
	_i_1_2+0	= 0x0200;		=>>I1	= rm[BP_SAVE];AX	= 0x0200;rm[I1]	= AX
LFB78B58C_30:;					=>>LFB78B58C_30:;
_AE23BDF6A_92:;					=>>_AE23BDF6A_92:;
...
rjmp void _WaitPCM_Empty_size53398B9D()		=>>_WaitPCM_Empty_size53398B9D:
{
	__int16 _x_1_2;
						=>>AR	= rm[BP_SAVE];push	AR;AR	= BP;rm[BP_SAVE]	= AR;AR	 = -1;BP	+= AR
_AE23BDF6A_111:;				=>>_AE23BDF6A_111:;
	
_AE23BDF6A_112:;				=>>_AE23BDF6A_112:;
	asm I1 = PCMYOU_PTR+0;			=>>I1 = PCMYOU_PTR+0//
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	asm I1 = PCMYIN_PTR+0;			=>>I1 = PCMYIN_PTR+0//
	sCX	= *(__int16*)sSI;		=>>CX	= rm[I1]
...
_AE23BDF6A_115:;				=>>_AE23BDF6A_115:;
_AE23BDF6A_116:;				=>>_AE23BDF6A_116:;
	sSI	= (int)&_x_1_2;			=>>I1	= rm[BP_SAVE]
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
...
rjmp void _Sub3ZeroFillABFF23AA()		=>>_Sub3ZeroFillABFF23AA:
{
	__int16 _i_1_2;
						=>>AR	= rm[BP_SAVE];push	AR;AR	= BP;rm[BP_SAVE]	= AR;AR	 = -1;BP	+= AR
_AE23BDF6A_120:;				=>>_AE23BDF6A_120:;
_AE23BDF6A_121:;				=>>_AE23BDF6A_121:;
	asm	push CBL			=>>push CBL
	
_AE23BDF6A_122:;				=>>_AE23BDF6A_122:;
	io[0x3B]	= 0x0009;		=>>AR	= 0x09;io[0x3B]	= AR
	
_AE23BDF6A_123:;				=>>_AE23BDF6A_123:;
	asm I1 = PCMYIN_PTR+0;			=>>I1 = PCMYIN_PTR+0//
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
_AE23BDF6A_124:;				=>>_AE23BDF6A_124:;
	asm	AR = AX				=>>AR = AX
_AE23BDF6A_125:;				=>>_AE23BDF6A_125:;
	asm	I0 = AR				=>>I0 = AR
	
_AE23BDF6A_126:;				=>>_AE23BDF6A_126:;
	_i_1_2+0	= 0x0120;		=>>I1	= rm[BP_SAVE];AX	= 0x0120;rm[I1]	= AX
LFB78B58C_38:;					=>>LFB78B58C_38:;
_AE23BDF6A_127:;				=>>_AE23BDF6A_127:;
	sSI	= (int)&_i_1_2;			=>>I1	= rm[BP_SAVE]
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sSI	= (int)&_i_1_2;			=>>I1	= rm[BP_SAVE]
	asm AR = 0x0001;			=>>AR = 0x0001//
...
_AE23BDF6A_128:;				=>>_AE23BDF6A_128:;
	sAX	= 0x0000;			=>>AX	= 0x00
_AE23BDF6A_129:;				=>>_AE23BDF6A_129:;
	asm	rm[I0++] = AX			=>>rm[I0++] = AX
_AE23BDF6A_130:;				=>>_AE23BDF6A_130:;
	goto LFB78B58C_38;			=>>jmp	LFB78B58C_38
LFB78B58C_37:;					=>>LFB78B58C_37:;
_AE23BDF6A_131:;				=>>_AE23BDF6A_131:;
_AE23BDF6A_132:;				=>>_AE23BDF6A_132:;
	get_I0();				=>>push	I0;pop	AX;
	asm I1 = PCMYIN_PTR+0;			=>>I1 = PCMYIN_PTR+0//
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AE23BDF6A_133:;				=>>_AE23BDF6A_133:;
	asm	pop CBL				=>>pop CBL
LFB78B58C_36:;					=>>LFB78B58C_36:;
_AE23BDF6A_134:;				=>>_AE23BDF6A_134:;
	return;					=>>AR	= 1;BP	+= AR;pop	AR;rm[BP_SAVE]	= AR;rets
_Sub3ZeroFillABFF23AA_end:;			=>>_Sub3ZeroFillABFF23AA_end:;
_AE23BDF6A_135:;				=>>_AE23BDF6A_135:;
}
...
_AE23BDF6A_136:;				=>>_AE23BDF6A_136:;
	
_AE23BDF6A_137:;				=>>_AE23BDF6A_137:;
...
_AE23BDF6A_138:;				=>>_AE23BDF6A_138:;
_AE23BDF6A_139:;				=>>_AE23BDF6A_139:;
	_Sub3Initial96BE24F3();			=>>pch	= _Sub3Initial96BE24F3;lcall	_Sub3Initial96BE24F3
_AE23BDF6A_140:;				=>>_AE23BDF6A_140:;
	asm AX = SUBFLTI+0;			=>>AX = SUBFLTI+0//
	PUSH(sAX);				=>>push	AX
	sAX	= 0x0000;			=>>AX	= 0x00
	sSI	= POP();			=>>pop	I1
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AE23BDF6A_141:;				=>>_AE23BDF6A_141:;
	asm AX = SUBFLTI+1;			=>>AX = SUBFLTI+1//
	PUSH(sAX);				=>>push	AX
	sAX	= 0x0000;			=>>AX	= 0x00
	sSI	= POP();			=>>pop	I1
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AE23BDF6A_142:;				=>>_AE23BDF6A_142:;
	asm AX = SUBFLTI+2;			=>>AX = SUBFLTI+2//
	PUSH(sAX);				=>>push	AX
	sAX	= 0x0000;			=>>AX	= 0x00
	sSI	= POP();			=>>pop	I1
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AE23BDF6A_143:;				=>>_AE23BDF6A_143:;
	asm AX = SUBFLTI+3;			=>>AX = SUBFLTI+3//
	PUSH(sAX);				=>>push	AX
	sAX	= 0x0000;			=>>AX	= 0x00
	sSI	= POP();			=>>pop	I1
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AE23BDF6A_144:;				=>>_AE23BDF6A_144:;
	sAX	= 0x0000;			=>>AX	= 0x00
	asm I1 = SUBFLTA+0;			=>>I1 = SUBFLTA+0//
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AE23BDF6A_145:;				=>>_AE23BDF6A_145:;
	asm I1 = SampleCh0Rate+0;		=>>I1 = SampleCh0Rate+0//
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	asm I1 = SUBFLTP+0;			=>>I1 = SUBFLTP+0//
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AE23BDF6A_146:;				=>>_AE23BDF6A_146:;
	sAX	= 0x003F;			=>>AX	= 0x3F
	asm I1 = SUBFLTG+0;			=>>I1 = SUBFLTG+0//
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AE23BDF6A_147:;				=>>_AE23BDF6A_147:;
	asm	set io[INTENA].b0		=>>set io[INTENA].b0
_AE23BDF6A_148:;				=>>_AE23BDF6A_148:;
	asm	eni				=>>eni
LFB78B58C_40:;					=>>LFB78B58C_40:;
_AE23BDF6A_149:;				=>>_AE23BDF6A_149:;
	return;					=>>pop	AR;rm[BP_SAVE]	= AR;rets
_Sub3Play422CAD6D_end:;				=>>_Sub3Play422CAD6D_end:;
_AE23BDF6A_150:;				=>>_AE23BDF6A_150:;
}

rjmp void Sbb_Ch0GetBts()			=>>Sbb_Ch0GetBts:
{
_AE23BDF6A_151:;				=>>_AE23BDF6A_151:;
_AE23BDF6A_152:;				=>>_AE23BDF6A_152:;
	asm	push I1				=>>push I1
_AE23BDF6A_153:;				=>>_AE23BDF6A_153:;
	asm	push P1				=>>push P1
_AE23BDF6A_154:;				=>>_AE23BDF6A_154:;
	asm	push AX				=>>push AX
_AE23BDF6A_155:;				=>>_AE23BDF6A_155:;
	asm	push BX				=>>push BX
_AE23BDF6A_156:;				=>>_AE23BDF6A_156:;
	asm	push CX				=>>push CX
_AE23BDF6A_157:;				=>>_AE23BDF6A_157:;
	asm	push DX				=>>push DX
_AE23BDF6A_158:;				=>>_AE23BDF6A_158:;
	asm	AR = P1.hh			=>>AR = P1.hh
_AE23BDF6A_159:;				=>>_AE23BDF6A_159:;
	asm	push AR				=>>push AR
	
_AE23BDF6A_160:;				=>>_AE23BDF6A_160:;
_AE23BDF6A_161:;				=>>_AE23BDF6A_161:;
_AE23BDF6A_162:;				=>>_AE23BDF6A_162:;
	asm I1 = bts_ch0_get_ix+0;		=>>I1 = bts_ch0_get_ix+0//
	sAX	= *(__int16*)sSI++;		=>>AX	= rm[I1++]
	sDX	= *(__int16*)sSI--;		=>>DX	= rm[I1--]
	...
	RESTORESP(1);				=>>pop	AR;
_AE23BDF6A_163:;				=>>_AE23BDF6A_163:;
	asm	pop AR				=>>pop AR
_AE23BDF6A_164:;				=>>_AE23BDF6A_164:;
	asm	P1.hh = AR			=>>P1.hh = AR
_AE23BDF6A_165:;				=>>_AE23BDF6A_165:;
	asm	pop DX				=>>pop DX
_AE23BDF6A_166:;				=>>_AE23BDF6A_166:;
	asm	pop CX				=>>pop CX
_AE23BDF6A_167:;				=>>_AE23BDF6A_167:;
	asm	pop BX				=>>pop BX
	
_AE23BDF6A_168:;				=>>_AE23BDF6A_168:;
_AE23BDF6A_169:;				=>>_AE23BDF6A_169:;
	asintax();				=>>_AE23BDF6A_170:;				=>>_AE23BDF6A_170:;
	asm	AR = AX				=>>AR = AX
_AE23BDF6A_171:;				=>>_AE23BDF6A_171:;
	asm	pop AX				=>>pop AX
_AE23BDF6A_172:;				=>>_AE23BDF6A_172:;
	asm	pop P1				=>>pop P1
_AE23BDF6A_173:;				=>>_AE23BDF6A_173:;
	asm	pop I1				=>>pop I1
LFB78B58C_41:;					=>>LFB78B58C_41:;
_AE23BDF6A_174:;				=>>_AE23BDF6A_174:;
	return;					=>>rets
Sbb_Ch0GetBts_end:;				=>>Sbb_Ch0GetBts_end:;
_AE23BDF6A_175:;				=>>_AE23BDF6A_175:;
}
...
_AE23BDF6A_176:;				=>>_AE23BDF6A_176:;
	return;					=>>pop	AR;rm[BP_SAVE]	= AR;rets
_Sbb_SkipdataE1C72441_end:;			=>>_Sbb_SkipdataE1C72441_end:;
_AE23BDF6A_177:;				=>>_AE23BDF6A_177:;
}

...
_A1690E9DD_351:;				=>>_A1690E9DD_351:;
	...
	sfx_CHECKZERO();			=>>AR	= AX;
	if(__jnz__)	goto LF2D2B0F3_115;	=>>if NZ	jmp LF2D2B0F3_115
	goto	LF2D2B0F3_113;			=>>jmp	LF2D2B0F3_113
LF2D2B0F3_115:;					=>>LF2D2B0F3_115:;
_A1690E9DD_352:;				=>>_A1690E9DD_352:;
	sSI	= (int)&_ret_1_2;		=>>I1	= rm[BP_SAVE]
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	PUSH(sAX);				=>>push	AX
...
_A1690E9DD_353:;				=>>_A1690E9DD_353:;
	goto LF2D2B0F3_114;			=>>jmp	LF2D2B0F3_114
LF2D2B0F3_113:;					=>>LF2D2B0F3_113:;
_A1690E9DD_354:;				=>>_A1690E9DD_354:;
	sSI	= (int)&_s_0_4;			=>>AR	= 2;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	goto LF2D2B0F3_112;			=>>jmp	LF2D2B0F3_112
LF2D2B0F3_112:;					=>>LF2D2B0F3_112:;
_A1690E9DD_355:;				=>>_A1690E9DD_355:;
	return;					=>>AR	= 1;BP	+= AR;pop	AR;rm[BP_SAVE]	= AR;rets
_memset_sC3E11DB1_end:;				=>>_memset_sC3E11DB1_end:;
_A1690E9DD_356:;				=>>_A1690E9DD_356:;
}
...
rcall rjmp void _memset_rC7200006(__int16 _s_0_4, __int16 _c_0_6, __int16 _n_0_8)=>>_memset_rC7200006:
{
	__int16 _ret_1_2;
						=>>AR	= rm[BP_SAVE];push	AR;AR	= BP;rm[BP_SAVE]	= AR;AR	 = -1;BP	+= AR
_A1690E9DD_357:;				=>>_A1690E9DD_357:;
	
_A1690E9DD_358:;				=>>_A1690E9DD_358:;
	sSI	= (int)&_s_0_4;			=>>AR	= 2;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sSI	= (int)&_ret_1_2;		=>>I1	= rm[BP_SAVE]
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
LF2D2B0F3_118:;					=>>LF2D2B0F3_118:;
_A1690E9DD_359:;				=>>_A1690E9DD_359:;
	sSI	= (int)&_n_0_8;			=>>AR	= 4;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sSI	= (int)&_n_0_8;			=>>AR	= 4;I1	= rm[BP_SAVE];I1	+= AR
	asm AR = 0x0001;			=>>AR = 0x0001//
	...
	asm rm[I1] = CX - AR;			=>>rm[I1] = CX - AR//
	sfx_CHECKZERO();			=>>AR	= AX;
	if(__jnz__)	goto LF2D2B0F3_119;	=>>if NZ	jmp LF2D2B0F3_119
	goto	LF2D2B0F3_117;			=>>jmp	LF2D2B0F3_117
LF2D2B0F3_119:;					=>>LF2D2B0F3_119:;
_A1690E9DD_360:;				=>>_A1690E9DD_360:;
	sSI	= (int)&_ret_1_2;		=>>I1	= rm[BP_SAVE]
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	PUSH(sAX);				=>>push	AX
	sSI	= (int)&_c_0_6;			=>>AR	= 3;I1	= rm[BP_SAVE];I1	+= AR
	...
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
	...
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	asm rm[I1] = AX + AR;			=>>rm[I1] = AX + AR//
_A1690E9DD_361:;				=>>_A1690E9DD_361:;
	goto LF2D2B0F3_118;			=>>jmp	LF2D2B0F3_118
LF2D2B0F3_117:;					=>>LF2D2B0F3_117:;
_A1690E9DD_362:;				=>>_A1690E9DD_362:;
	sSI	= (int)&_s_0_4;			=>>AR	= 2;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	goto LF2D2B0F3_116;			=>>jmp	LF2D2B0F3_116
LF2D2B0F3_116:;					=>>LF2D2B0F3_116:;
_A1690E9DD_363:;				=>>_A1690E9DD_363:;
	return;					=>>AR	= 1;BP	+= AR;pop	AR;rm[BP_SAVE]	= AR;rets
_memset_rC7200006_end:;				=>>_memset_rC7200006_end:;
_A1690E9DD_364:;				=>>_A1690E9DD_364:;
}
...
_A1690E9DD_365:;				=>>_A1690E9DD_365:;
	
_A1690E9DD_366:;				=>>_A1690E9DD_366:;
...
_A1690E9DD_367:;				=>>_A1690E9DD_367:;
_A1690E9DD_368:;				=>>_A1690E9DD_368:;
...
_A1690E9DD_369:;				=>>_A1690E9DD_369:;
_A1690E9DD_370:;				=>>_A1690E9DD_370:;
_A1690E9DD_371:;				=>>_A1690E9DD_371:;
	sSI	= (int)&_n_0_10;		=>>AR	= 5;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	PUSH(sAX);				=>>push	AX
	sSI	= (int)&_c_0_8;			=>>AR	= 4;I1	= rm[BP_SAVE];I1	+= AR

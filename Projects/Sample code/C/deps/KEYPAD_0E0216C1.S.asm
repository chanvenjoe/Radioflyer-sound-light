...
_AECA8DE46_274:;				=>>_AECA8DE46_274:;
	
_AECA8DE46_275:;				=>>_AECA8DE46_275:;
_AECA8DE46_276:;				=>>_AECA8DE46_276:;
	NEARCALL(L5589D4CE_71);			=>>call	L5589D4CE_71
	sSI	= (int)&_keynow_1_2;		=>>I1	= rm[BP_SAVE]
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AECA8DE46_277:;				=>>_AECA8DE46_277:;
...
_AECA8DE46_278:;				=>>_AECA8DE46_278:;
	sSI	= (int)&_keynow_1_2;		=>>I1	= rm[BP_SAVE]
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sSI	= (int)&L5589D4CE_67;		=>>I1	= L5589D4CE_67
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AECA8DE46_279:;				=>>_AECA8DE46_279:;
	sAX	= 0x0200;			=>>AX	= 0x0200
	sSI	= (int)&L5589D4CE_69;		=>>I1	= L5589D4CE_69
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AECA8DE46_280:;				=>>_AECA8DE46_280:;
	goto L5589D4CE_74;			=>>jmp	L5589D4CE_74
L5589D4CE_75:;					=>>L5589D4CE_75:;
_AECA8DE46_281:;				=>>_AECA8DE46_281:;
_AECA8DE46_282:;				=>>_AECA8DE46_282:;
...
_AECA8DE46_283:;				=>>_AECA8DE46_283:;
	...
	sSI	= (int)&L5589D4CE_69;		=>>I1	= L5589D4CE_69
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AECA8DE46_284:;				=>>_AECA8DE46_284:;
	goto L5589D4CE_74;			=>>jmp	L5589D4CE_74
L5589D4CE_77:;					=>>L5589D4CE_77:;
_AECA8DE46_285:;				=>>_AECA8DE46_285:;
_AECA8DE46_286:;				=>>_AECA8DE46_286:;
	asm AX = #_keyfuncF06F3D55+0;		=>>AX = #_keyfuncF06F3D55+0//
	sSI	= (int)&_pkey_1_10;		=>>AR	= -4;I1	= rm[BP_SAVE];I1	+= AR
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AECA8DE46_287:;				=>>_AECA8DE46_287:;
	sAX	= 0x0200;			=>>AX	= 0x0200
	sSI	= (int)&L5589D4CE_69;		=>>I1	= L5589D4CE_69
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AECA8DE46_288:;				=>>_AECA8DE46_288:;
...
_AECA8DE46_296:;				=>>_AECA8DE46_296:;
_AECA8DE46_297:;				=>>_AECA8DE46_297:;
	sSI	= (int)&_pkey_1_10;		=>>AR	= -4;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sCX	= 0x0002;			=>>CX	= 0x02
	sAX	= sAX + sCX;			=>>AR	= CX;AX	+= AR
...
_AECA8DE46_300:;				=>>_AECA8DE46_300:;
_AECA8DE46_301:;				=>>_AECA8DE46_301:;
	sSI	= (int)&_pkey_1_10;		=>>AR	= -4;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sDI	= sAX;				=>>AR	= AX;P1	= AR
	sAX	= *(__int16*)sDI;		=>>AX	= pm[P1]
...
_AECA8DE46_302:;				=>>_AECA8DE46_302:;
L5589D4CE_90:;					=>>L5589D4CE_90:;
_AECA8DE46_303:;				=>>_AECA8DE46_303:;
	goto L5589D4CE_93;			=>>jmp	L5589D4CE_93
L5589D4CE_82:;					=>>L5589D4CE_82:;
	
_AECA8DE46_304:;				=>>_AECA8DE46_304:;
	sAX	= 0;				=>>AX	= 0x00
	sSI	= (int)&_bitp_1_8+0;		=>>AR	= -3;I1	= rm[BP_SAVE];I1	+= AR
	asm AR = rm[I1];			=>>AR = rm[I1]//
	asm test AR.b0;				=>>test AR.b0//
...
_AECA8DE46_306:;				=>>_AECA8DE46_306:;
_AECA8DE46_307:;				=>>_AECA8DE46_307:;
	sSI	= (int)&_pkey_1_10;		=>>AR	= -4;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sCX	= 0x0001;			=>>CX	= 0x01
	sAX	= sAX + sCX;			=>>AR	= CX;AX	+= AR
...
_AECA8DE46_308:;				=>>_AECA8DE46_308:;
L5589D4CE_94:;					=>>L5589D4CE_94:;
_AECA8DE46_309:;				=>>_AECA8DE46_309:;
L5589D4CE_93:;					=>>L5589D4CE_93:;
_AECA8DE46_310:;				=>>_AECA8DE46_310:;
_AECA8DE46_311:;				=>>_AECA8DE46_311:;
	sSI	= (int)&_bits_1_6;		=>>AR	= -2;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	asm sra AX, 1;				=>>sra AX, 1//
	sSI	= (int)&_bits_1_6;		=>>AR	= -2;I1	= rm[BP_SAVE];I1	+= AR
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AECA8DE46_312:;				=>>_AECA8DE46_312:;
	sSI	= (int)&_bitp_1_8;		=>>AR	= -3;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	asm sra AX, 1;				=>>sra AX, 1//
	sSI	= (int)&_bitp_1_8;		=>>AR	= -3;I1	= rm[BP_SAVE];I1	+= AR
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AECA8DE46_313:;				=>>_AECA8DE46_313:;
	sSI	= (int)&_pkey_1_10;		=>>AR	= -4;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sSI	= (int)&_pkey_1_10;		=>>AR	= -4;I1	= rm[BP_SAVE];I1	+= AR

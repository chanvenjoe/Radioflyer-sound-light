...
_AA01D89BC_270:;				=>>_AA01D89BC_270:;
	
_AA01D89BC_271:;				=>>_AA01D89BC_271:;
_AA01D89BC_272:;				=>>_AA01D89BC_272:;
	NEARCALL(L5589D4CE_71);			=>>call	L5589D4CE_71
	sSI	= (int)&_keynow_1_2;		=>>I1	= rm[BP_SAVE]
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AA01D89BC_273:;				=>>_AA01D89BC_273:;
...
_AA01D89BC_274:;				=>>_AA01D89BC_274:;
	sSI	= (int)&_keynow_1_2;		=>>I1	= rm[BP_SAVE]
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sSI	= (int)&L5589D4CE_67;		=>>I1	= L5589D4CE_67
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AA01D89BC_275:;				=>>_AA01D89BC_275:;
	sAX	= 0x0200;			=>>AX	= 0x0200
	sSI	= (int)&L5589D4CE_69;		=>>I1	= L5589D4CE_69
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AA01D89BC_276:;				=>>_AA01D89BC_276:;
	goto L5589D4CE_74;			=>>jmp	L5589D4CE_74
L5589D4CE_75:;					=>>L5589D4CE_75:;
_AA01D89BC_277:;				=>>_AA01D89BC_277:;
_AA01D89BC_278:;				=>>_AA01D89BC_278:;
...
_AA01D89BC_279:;				=>>_AA01D89BC_279:;
	...
	sSI	= (int)&L5589D4CE_69;		=>>I1	= L5589D4CE_69
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AA01D89BC_280:;				=>>_AA01D89BC_280:;
	goto L5589D4CE_74;			=>>jmp	L5589D4CE_74
L5589D4CE_77:;					=>>L5589D4CE_77:;
_AA01D89BC_281:;				=>>_AA01D89BC_281:;
_AA01D89BC_282:;				=>>_AA01D89BC_282:;
	asm AX = #_keyfuncF06F3D55+0;		=>>AX = #_keyfuncF06F3D55+0//
	sSI	= (int)&_pkey_1_10;		=>>AR	= -4;I1	= rm[BP_SAVE];I1	+= AR
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AA01D89BC_283:;				=>>_AA01D89BC_283:;
	sAX	= 0x0200;			=>>AX	= 0x0200
	sSI	= (int)&L5589D4CE_69;		=>>I1	= L5589D4CE_69
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_AA01D89BC_284:;				=>>_AA01D89BC_284:;
...
_AA01D89BC_292:;				=>>_AA01D89BC_292:;
_AA01D89BC_293:;				=>>_AA01D89BC_293:;
	sSI	= (int)&_pkey_1_10;		=>>AR	= -4;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sCX	= 0x0002;			=>>CX	= 0x02
	sAX	= sAX + sCX;			=>>AR	= CX;AX	+= AR
...
_AA01D89BC_296:;				=>>_AA01D89BC_296:;
_AA01D89BC_297:;				=>>_AA01D89BC_297:;
	sSI	= (int)&_pkey_1_10;		=>>AR	= -4;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sDI	= sAX;				=>>AR	= AX;P1	= AR
	sAX	= *(__int16*)sDI;		=>>AX	= pm[P1]
...
_AA01D89BC_298:;				=>>_AA01D89BC_298:;
L5589D4CE_90:;					=>>L5589D4CE_90:;
_AA01D89BC_299:;				=>>_AA01D89BC_299:;
	goto L5589D4CE_93;			=>>jmp	L5589D4CE_93
L5589D4CE_82:;					=>>L5589D4CE_82:;
	
_AA01D89BC_300:;				=>>_AA01D89BC_300:;
	sAX	= 0;				=>>AX	= 0x00
	sSI	= (int)&_bitp_1_8+0;		=>>AR	= -3;I1	= rm[BP_SAVE];I1	+= AR
	asm AR = rm[I1];			=>>AR = rm[I1]//
	asm test AR.b0;				=>>test AR.b0//
...
_AA01D89BC_302:;				=>>_AA01D89BC_302:;
_AA01D89BC_303:;				=>>_AA01D89BC_303:;
	sSI	= (int)&_pkey_1_10;		=>>AR	= -4;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sCX	= 0x0001;			=>>CX	= 0x01
	sAX	= sAX + sCX;			=>>AR	= CX;AX	+= AR
...
_AA01D89BC_304:;				=>>_AA01D89BC_304:;
L5589D4CE_94:;					=>>L5589D4CE_94:;
_AA01D89BC_305:;				=>>_AA01D89BC_305:;
L5589D4CE_93:;					=>>L5589D4CE_93:;
_AA01D89BC_306:;				=>>_AA01D89BC_306:;
_AA01D89BC_307:;				=>>_AA01D89BC_307:;
	sSI	= (int)&_bits_1_6;		=>>AR	= -2;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	asm sra AX, 1;				=>>sra AX, 1//
	sSI	= (int)&_bits_1_6;		=>>AR	= -2;I1	= rm[BP_SAVE];I1	+= AR
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AA01D89BC_308:;				=>>_AA01D89BC_308:;
	sSI	= (int)&_bitp_1_8;		=>>AR	= -3;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	asm sra AX, 1;				=>>sra AX, 1//
	sSI	= (int)&_bitp_1_8;		=>>AR	= -3;I1	= rm[BP_SAVE];I1	+= AR
	*(__int16*)sSI	= sAX;			=>>rm[I1]	= AX
_AA01D89BC_309:;				=>>_AA01D89BC_309:;
	sSI	= (int)&_pkey_1_10;		=>>AR	= -4;I1	= rm[BP_SAVE];I1	+= AR
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sSI	= (int)&_pkey_1_10;		=>>AR	= -4;I1	= rm[BP_SAVE];I1	+= AR

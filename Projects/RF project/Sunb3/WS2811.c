...
/*void WS_TRSF_color_set(Color_Typedef color)//can only transfer 16 bits of data in this chip?
{
	u8 i,j;
	...
	for(j=0;j<LEDNUM;j++)
	{
		for(i=0;i<24;i++)
		{
			if( i<8)
			{
				if(color.G & 0x80)// 0000 0000 1000 0000... the highest bit & color, then the MCU can send 24bits data to WS2812
				{
					CODE_1	
				}
				else CODE_0
			...
			{
				if(color.R & 0x80)// 0000 0000 1000 0000... the highest bit & color, then the MCU can send 24bits data to WS2812
				{
					CODE_1	
				}
				else CODE_0

...
_A8ADEC9C4_0:;					=>>_A8ADEC9C4_0:;
_A8ADEC9C4_1:;					=>>_A8ADEC9C4_1:;
	asm	clr io[INTREQ].b3		=>>clr io[INTREQ].b3
	
_A8ADEC9C4_2:;					=>>_A8ADEC9C4_2:;
	sAX	= 0;				=>>AX	= 0x00
...
L2A70A9A2_7:;					=>>L2A70A9A2_7:;
	sSI	= (int)&L2A70A9A2_4;		=>>I1	= L2A70A9A2_4
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
_A8ADEC9C4_3:;					=>>_A8ADEC9C4_3:;
	asm I1 = L2A70A9A2_3+0;			=>>I1 = L2A70A9A2_3+0//
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sCX	= 0x0000;			=>>CX	= 0x00
	sfx_CMP_AX_CX_JE();			=>>pch	= sfx_CMP_AX_CX_JE;lcall	sfx_CMP_AX_CX_JE
	if(__je__)	goto L2A70A9A2_11;	=>>if ZR	jmp L2A70A9A2_11
	goto	L2A70A9A2_10;			=>>jmp	L2A70A9A2_10
L2A70A9A2_11:;					=>>L2A70A9A2_11:;
	
_A8ADEC9C4_4:;					=>>_A8ADEC9C4_4:;
_A8ADEC9C4_5:;					=>>_A8ADEC9C4_5:;
	sAX	= 0x0003;			=>>AX	= 0x03
	PUSH(sAX);				=>>push	AX
	sAX	= 0x0005;			=>>AX	= 0x05
	PUSH(sAX);				=>>push	AX
...
_A8ADEC9C4_9:;					=>>_A8ADEC9C4_9:;
	...
	_WS_TRSF_color_setE1CC300C(STACK[sSP + 0], STACK[sSP + 1]);=>>pch	= _WS_TRSF_color_setE1CC300C;lcall	_WS_TRSF_color_setE1CC300C
	RESTORESP(2);				=>>pop	AR;pop	AR;
_A8ADEC9C4_10:;					=>>_A8ADEC9C4_10:;
	asm clr io[0x09].b14;			=>>clr io[0x09].b14//
	goto L2A70A9A2_15;			=>>jmp	L2A70A9A2_15
L2A70A9A2_13:;					=>>L2A70A9A2_13:;
_A8ADEC9C4_11:;					=>>_A8ADEC9C4_11:;
	asm I1 = L2A70A9A2_3+0;			=>>I1 = L2A70A9A2_3+0//
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sCX	= 0x0002;			=>>CX	= 0x02
	sfx_CMP_AX_CX_JE();			=>>pch	= sfx_CMP_AX_CX_JE;lcall	sfx_CMP_AX_CX_JE
	if(__je__)	goto L2A70A9A2_17;	=>>if ZR	jmp L2A70A9A2_17
	goto	L2A70A9A2_16;			=>>jmp	L2A70A9A2_16
L2A70A9A2_17:;					=>>L2A70A9A2_17:;
	
_A8ADEC9C4_12:;					=>>_A8ADEC9C4_12:;
_A8ADEC9C4_13:;					=>>_A8ADEC9C4_13:;
	sAX	= 0x0003;			=>>AX	= 0x03
	PUSH(sAX);				=>>push	AX
	sAX	= 0x0004;			=>>AX	= 0x04
	PUSH(sAX);				=>>push	AX
	_WS_TRSF_color_setE1CC300C(STACK[sSP + 0], STACK[sSP + 1]);=>>pch	= _WS_TRSF_color_setE1CC300C;lcall	_WS_TRSF_color_setE1CC300C
	RESTORESP(2);				=>>pop	AR;pop	AR;
_A8ADEC9C4_14:;					=>>_A8ADEC9C4_14:;
	asm clr io[0x09].b14;			=>>clr io[0x09].b14//
L2A70A9A2_16:;					=>>L2A70A9A2_16:;
_A8ADEC9C4_15:;					=>>_A8ADEC9C4_15:;
L2A70A9A2_15:;					=>>L2A70A9A2_15:;
_A8ADEC9C4_16:;					=>>_A8ADEC9C4_16:;
L2A70A9A2_12:;					=>>L2A70A9A2_12:;
_A8ADEC9C4_17:;					=>>_A8ADEC9C4_17:;
_A8ADEC9C4_18:;					=>>_A8ADEC9C4_18:;
	asm I1 = L2A70A9A2_3+0;			=>>I1 = L2A70A9A2_3+0//
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	...
	*(__int16*)sSI	= sCX;			=>>rm[I1]	= CX
	sAX	= POP();			=>>pop	AX
_A8ADEC9C4_19:;					=>>_A8ADEC9C4_19:;
	asm I1 = L2A70A9A2_3+0;			=>>I1 = L2A70A9A2_3+0//
	sAX	= *(__int16*)sSI;		=>>AX	= rm[I1]
	sCX	= 0x0002;			=>>CX	= 0x02
	sfx_CMP_AX_CX_JE();			=>>pch	= sfx_CMP_AX_CX_JE;lcall	sfx_CMP_AX_CX_JE
	if(__je__)	goto L2A70A9A2_19;	=>>if ZR	jmp L2A70A9A2_19
	goto	L2A70A9A2_18;			=>>jmp	L2A70A9A2_18
L2A70A9A2_19:;					=>>L2A70A9A2_19:;
_A8ADEC9C4_20:;					=>>_A8ADEC9C4_20:;
	sAX	= 0x0000;			=>>AX	= 0x00
	sSI	= (int)&L2A70A9A2_3;		=>>I1	= L2A70A9A2_3
	*(__int16*)sSI	= sAX			=>>rm[I1]	= AX
L2A70A9A2_18:;					=>>L2A70A9A2_18:;
_A8ADEC9C4_21:;					=>>_A8ADEC9C4_21:;
L2A70A9A2_5:;					=>>L2A70A9A2_5:;
_A8ADEC9C4_22:;					=>>_A8ADEC9C4_22:;
...
_A8ADEC9C4_36:;					=>>_A8ADEC9C4_36:;
_A8ADEC9C4_37:;					=>>_A8ADEC9C4_37:;
	asm	io[ClrWDT] = AR			=>>io[ClrWDT] = AR
	
	goto L2A70A9A2_22;			=>>jmp	L2A70A9A2_22
L2A70A9A2_21:;					=>>L2A70A9A2_21:;
L2A70A9A2_20:;					=>>L2A70A9A2_20:;
_A8ADEC9C4_38:;					=>>_A8ADEC9C4_38:;
	return;					=>>rets
_main_end:;					=>>_main_end:;
_A8ADEC9C4_39:;					=>>_A8ADEC9C4_39:;
}

rjmp void _InitSound5CCD501D()			=>>_InitSound5CCD501D:
{
_A8ADEC9C4_40:;					=>>_A8ADEC9C4_40:;
	
_A8ADEC9C4_41:;					=>>_A8ADEC9C4_41:;
	io[0x3E]	= 0x3FFF;		=>>AR	= 0x3FFF;io[0x3E]	= AR
_A8ADEC9C4_42:;					=>>_A8ADEC9C4_42:;
	io[0x16]	= 0x0000;		=>>AR	= 0x00;io[0x16]	= AR
_A8ADEC9C4_43:;					=>>_A8ADEC9C4_43:;
	io[0x16]	= 0x0000;		=>>AR	= 0x00;io[0x16]	= AR
_A8ADEC9C4_44:;					=>>_A8ADEC9C4_44:;
	io[0x16]	= 0x0000;		=>>AR	= 0x00;io[0x16]	= AR
_A8ADEC9C4_45:;					=>>_A8ADEC9C4_45:;
	io[0x16]	= 0x0000;		=>>AR	= 0x00;io[0x16]	= AR
_A8ADEC9C4_46:;					=>>_A8ADEC9C4_46:;
	io[0x36]	= 0x0000;		=>>AR	= 0x00;io[0x36]	= AR
_A8ADEC9C4_47:;					=>>_A8ADEC9C4_47:;
	io[0x36]	= 0x0000;		=>>AR	= 0x00;io[0x36]	= AR
_A8ADEC9C4_48:;					=>>_A8ADEC9C4_48:;
	io[0x36]	= 0x0000;		=>>AR	= 0x00;io[0x36]	= AR
_A8ADEC9C4_49:;					=>>_A8ADEC9C4_49:;
	io[0x36]	= 0x0000;		=>>AR	= 0x00;io[0x36]	= AR
_A8ADEC9C4_50:;					=>>_A8ADEC9C4_50:;
	io[0x36]	= 0x0000;		=>>AR	= 0x00;io[0x36]	= AR
_A8ADEC9C4_51:;					=>>_A8ADEC9C4_51:;
	io[0x36]	= 0x0000;		=>>AR	= 0x00;io[0x36]	= AR
_A8ADEC9C4_52:;					=>>_A8ADEC9C4_52:;
	io[0x36]	= 0x0000;		=>>AR	= 0x00;io[0x36]	= AR
_A8ADEC9C4_53:;					=>>_A8ADEC9C4_53:;
	io[0x36]	= 0x0000;		=>>AR	= 0x00;io[0x36]	= AR
_A8ADEC9C4_54:;					=>>_A8ADEC9C4_54:;
	io[0x3C]	= 0x0000;		=>>AR	= 0x00;io[0x3C]	= AR
_A8ADEC9C4_55:;					=>>_A8ADEC9C4_55:;
	sAX	= io[0x3C];			=>>AR	= io[0x3C];AX	= AR
_A8ADEC9C4_56:;					=>>_A8ADEC9C4_56:;
	asm	set io[MISC].b9			=>>set io[MISC].b9
_A8ADEC9C4_57:;					=>>_A8ADEC9C4_57:;
	asm	set io[MISC].b8			=>>set io[MISC].b8
_A8ADEC9C4_58:;					=>>_A8ADEC9C4_58:;
	asm	set io[MISC].b4			=>>set io[MISC].b4
L2A70A9A2_23:;					=>>L2A70A9A2_23:;
_A8ADEC9C4_59:;					=>>_A8ADEC9C4_59:;
	return;					=>>rets
_InitSound5CCD501D_end:;			=>>_InitSound5CCD501D_end:;
_A8ADEC9C4_60:;					=>>_A8ADEC9C4_60:;
}
...
_A8ADEC9C4_61:;					=>>_A8ADEC9C4_61:;
_A8ADEC9C4_62:;					=>>_A8ADEC9C4_62:;
_A8ADEC9C4_63:;					=>>_A8ADEC9C4_63:;
	NEARCALL(_InitSound5CCD501D);		=>>call	_InitSound5CCD501D
	
_A8ADEC9C4_64:;					=>>_A8ADEC9C4_64:;
	asm AX = PCMY+0;			=>>AX = PCMY+0//
_A8ADEC9C4_65:;					=>>_A8ADEC9C4_65:;
	asm	AR = AX				=>>AR = AX
_A8ADEC9C4_66:;					=>>_A8ADEC9C4_66:;
	asm	I0 = AR				=>>I0 = AR
_A8ADEC9C4_67:;					=>>_A8ADEC9C4_67:;
	_i_1_2+0	= 0x0200;		=>>I1	= rm[BP_SAVE];AR	= 0x0200;rm[I1]	= AR
L2A70A9A2_26:;					=>>L2A70A9A2_26:;
_A8ADEC9C4_68:;					=>>_A8ADEC9C4_68:;
...
naked void ginit_code_SUNB3_593950F9_s(void)	=>>ginit_code_SUNB3_593950F9_s:
{
	...
	asm I1 = L2A70A9A2_4;			=>>I1 = L2A70A9A2_4//
	sCX = 1;				=>>CX	= 0x01
	sfx_GLOBALINIT();			=>>pch	= sfx_GLOBALINIT;lcall	sfx_GLOBALINIT

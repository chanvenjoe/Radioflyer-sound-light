; ..\..\Sample code\How do I play DTX and subband3 simultaneously\sub3play.c Code Start!!;
VarRM[0:4095]={
...
ginit_code_sub3play_DFFE7AB1_s:
; //{
; //	return;					
	rets
; //}
